...
function nextPage() {
  let index = 0;
	...
	document.getElementsByClassName('p-final-info')[0].innerText = `Nome: ${listaInfo['name']} ${listaInfo['lastname']}`
	document.getElementsByClassName('p-final-info')[1].innerText = `Email: ${listaInfo['email']}`
	document.getElementsByClassName('p-final-info')[2].innerText = `Casa: ${listaInfo['casa']}`
	document.getElementsByClassName('p-final-info')[3].innerText = `Família: ${listaInfo['family']}`
	document.getElementsByClassName('p-final-info')[4].innerText = `Matérias:${listaInfo['check']}`
	document.getElementsByClassName('p-final-info')[5].innerText = `Avaliação: ${listaInfo['rate']}`
	document.getElementsByClassName('p-final-info')[6].innerText = `Observações: ${listaInfo['textarea']}`
}
